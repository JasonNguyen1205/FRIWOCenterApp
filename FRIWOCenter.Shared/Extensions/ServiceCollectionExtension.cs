...
using FRIWOCenter.Shared.Services;
using FRIWOCenter.Shared.ViewModels;
using FRIWOCenter.Shared.ViewModels.Interfaces;
using Microsoft.AspNetCore.Components.Authorization;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Logging;

namespace FRIWOCenter.Shared.Extensions
{
    public static class ServiceCollectionExtension
    {
        public static IServiceCollection AddFRIWOCenter(this IServiceCollection services,
